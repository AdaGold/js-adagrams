...
export const drawLetters = () => {
    // choose random index of letters from letterlist
...
export const usesAvailableLetters = (input, lettersInHand) => {
        ...
        }; return valid.length == input.length;
}; 
...
//     constructor(word, words, input, lettersInHand){
//       this.word = word;
//       this.words = words;
//       this.input = input;
...
// let myAdagrams = new Adagrams('word', ['XX', 'XS'], 'input', 'LETTERS'); 


// console.log(myAdagrams.word); 
